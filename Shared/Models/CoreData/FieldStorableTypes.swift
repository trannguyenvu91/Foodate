...
extension FDInvitationState: FieldStorableType {
    
    static func cs_fromFieldStoredNativeType(_ value: String) -> FDInvitationState {
        FDInvitationState(rawValue: value) ?? .archived
    }
